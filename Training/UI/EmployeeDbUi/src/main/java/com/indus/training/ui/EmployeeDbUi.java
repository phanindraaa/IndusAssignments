...
public class EmployeeDbUi {
	 public static void main(String[] args) throws EmpDataException, SQLException {
	        ...
	        String configFilePath = EmployeeDbUi.class.getClassLoader().getResource("dbconfig.properties").getPath();
	            ...
	            try {
	                ...
	                switch (choice) {
	                    case 1:
	                        ...
	                        empDetailsObj.setEmpAddress(Address);
