...
//        assertEquals(1, userList.size());
    ...
    @Test
    public void testCustomerDAOName() {
        String customerDAOName = petStoreService.getCustomerDAOName();
        assertEquals("Using CustomerDAO with name: customerDAO", customerDAOName);
    }
}
