...
public class PetStoreServiceImpl implements PetStoreService {
    ...
    public void setCustomerDAOName(String customerDAOName) {
        this.customerDAOName = customerDAOName;
    }
    
    // New method to demonstrate the use of idref
    @Override
    public String getCustomerDAOName() {
        return "Using CustomerDAO with name: " + customerDAOName;
    }
}
