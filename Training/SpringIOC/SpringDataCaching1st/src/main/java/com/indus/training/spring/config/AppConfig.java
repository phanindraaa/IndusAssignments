...
import com.indus.training.spring.cache.MonitoringCacheManager;
...
public class AppConfig {
    ...
    public CacheManager cacheManager() {
        ConcurrentMapCacheManager delegateCacheManager = new ConcurrentMapCacheManager("employeeCache");
        return new MonitoringCacheManager(delegateCacheManager);
    }
