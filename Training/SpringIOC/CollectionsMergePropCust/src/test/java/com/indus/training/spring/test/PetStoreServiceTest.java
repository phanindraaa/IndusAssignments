...
//        assertEquals(1, userList.size());
    ...
    @Test
    public void testSupportEmailsMerging() {
        Properties supportEmails = petStoreService.getSupportEmails();
        assertEquals("support@petstore.com", supportEmails.getProperty("general"));
        assertEquals("neworders@petstore.com", supportEmails.getProperty("orders"));
        assertEquals("returns@petstore.com", supportEmails.getProperty("returns"));
    }
}
