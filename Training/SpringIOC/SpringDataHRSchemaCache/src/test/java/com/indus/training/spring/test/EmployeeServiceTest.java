...
//    
    ...
    public void testCaching() {
        // First call - should retrieve from the database and cache the result
        Employee employee1 = employeeService.getEmployeeById(emp1Id);

        // Second call - should retrieve from the cache, not the database
        Employee employee2 = employeeService.getEmployeeById(emp1Id);

        // Both calls should return the same employee
